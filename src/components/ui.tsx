...
const STATUS_LABEL: Record<string, { label: string; tone: string }> = {
  ...
  CHECK_FAILED: { label: "Vérification impossible", tone: "warn" },
  RESPONSE_RECEIVED: { label: "Réponse reçue", tone: "ok" },
  REVIEW_REQUIRED: { label: "À vérifier", tone: "warn" },
  REMINDED: { label: "Rappel envoyé", tone: "primary" },
  SENT: { label: "Envoyée", tone: "ok" },
  SUPERSEDED: { label: "Obsolète", tone: "" },
  MAX_ATTEMPTS_REACHED: { label: "Sans réponse", tone: "warn" },
